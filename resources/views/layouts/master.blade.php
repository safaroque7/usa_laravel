        ...
        <div class="flex bg-gray-500 justify-between shadow-lg py-5">
            ...
            <div class="w-auto flex justify-end items-center mr-5">
                ...
                <a href="{{ url('/settings') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor"
                        class="w-6 h-6 inline-block text-white mr-3 hover:text-yellow-500 transition">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="w-10 h-10 overflow-hidden rounded-full">
                    <a href="#"> <img src="{{ asset('images/user.jpeg') }}" alt="user"
                ...
                <div class="flex flex-col justify-between">
                    <nav class="text-white overflow-auto h-screen">
                        ...
                        <li class="list-none w-full">
                            <a href="{{ url('/addClients') }}"
                                class="border-b last:border-0 py-2 px-2 hover:bg-gray-950 duration-500 block">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
